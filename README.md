...
| [Annoti](https://github.com/AkutaZehy/Annoti)<sup>4</sup>                   | 一个阅读的工具，主要用于阅读时批注的需求。                                      | 可能有应用方向，v0.1-alpha，**开发中** | Flutter(Dart) for Window Desktop                                                 | AI生成，人类改进             | /                                                                                                                                                                                                                                     |
| [blocky-markdown](https://github.com/AkutaZehy/blocky-markdown)<sup>5</sup> | 一个极简主义的Markdown编辑器，具有基于块的界面，提供与WordPress类似的编辑体验。 | 也许有点用                             | 纯前端（html+css+js）+[Marked.js](https://github.com/markedjs/marked)            | 【当前】全部AI，人类没写一行 | /                                                                                                                                                                                                                                     |
...
基本上都是纯前端，运行于[Live Server](https://github.com/tapio/live-server)，这个是VS Code的插件在Market也有。
3. 纯闲的.jpg<br>
